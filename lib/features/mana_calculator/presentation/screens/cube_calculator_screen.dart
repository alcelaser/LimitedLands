      ...
      children: [
        SingleChildScrollView(
          ...
          child: Column(
            ...
            _ManaSourceSection(
              title: 'Shock Lands',
              subtitle: 'Ravnica shocklands',
              icon: Icons.bolt,
              iconColor: Colors.red.shade300,
              sources: state.shockLands,
              onToggle: notifier.toggleShockLand,
              onReset: notifier.resetShockLand,
            ),
            const SizedBox(height: 12),
            _ManaSourceSection(
              title: 'Surveil Lands',
              subtitle: 'Karlov Manor surveil duals',
              icon: Icons.visibility,
              iconColor: Colors.blue.shade300,
              sources: state.surveilLands,
              onToggle: notifier.toggleSurveilLand,
              onReset: notifier.resetSurveilLand,
            ),
            const SizedBox(height: 12),
            _ManaSourceSection(
              title: 'Triomes',
              subtitle: 'Three-color lands',
              icon: Icons.filter_3,
              iconColor: Colors.green.shade300,
              sources: state.triomeLands,
              onToggle: notifier.toggleTriomeLand,
              onReset: notifier.resetTriomeLand,
            ),
            const SizedBox(height: 12),
            _ManaSourceSection(
              title: 'Other Lands',
